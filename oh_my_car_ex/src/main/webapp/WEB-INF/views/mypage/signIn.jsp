...
<body>
	...
	<main class="page-wrapper">
		...
		<div class="d-lg-flex position-relative h-100">
			...
			<a
				...
				href="index.html" data-bs-toggle="tooltip" data-bs-placement="left"
				title="Back to home"><i class="ai-home"></i></a>
			<!-- Sign in form-->
			<div
				class="d-flex flex-column align-items-center w-lg-50 h-100 px-3 px-lg-5 pt-5">
				<div class="w-100 mt-auto"
					style="max-width: 526px; font-family: 'MICEGothic Bold';">
					<h1 class="mice">Sign in</h1>
					<p class="pb-3 mb-3 mb-lg-4">
						아직 계정이 없으세요?&nbsp;&nbsp;<a href="${path}/mypage/signUp">회원가입
							하러가기</a>
					</p>
					<form class="needs-validation" novalidate name="signIn"
						...
						<div class="mb-4">
							<div class="position-relative">
								...
								<div class="password-toggle">
									<input class="form-control form-control-lg ps-5"
						...
						<div
							...
							<form-check class="my-1"> <input
								class="form-check-input" type="checkbox" id="keep-signedin">
							<label class="form-check-label ms-1" for="keep-signedin">아이디
								저장</label> </form-check>
							<a class="fs-sm fw-semibold text-decoration-none my-1"
								href="${path}/error">비밀번호를 잊었어요.</a>
						</div>
						<!-- 회원가입 버튼 -->
						<button class="btn btn-lg btn-primary w-100 mb-2" type="submit">Sign
							In</button>
						<h2 class="h6 text-center pt-3 pt-lg-4 mb-4">Or sign in with
							your social account</h2>
					</form>
					<div class="pb-3 mb-3 row-cols-3 row-cols-sm-2 gy-3">
						<button
							onclick="location.href='https://kauth.kakao.com/oauth/authorize?client_id=bb1b195fa1cb4272d2535902db3d9984&redirect_uri=http://localhost/realfinal/kakao/callback&response_type=code'"
							class="btn btn-lg btn-primary w-100 mb-2"
							style="background-color: #FEE500; border-color: #FEE500; border-radius: 12px; height: 57px;"
							type="button" id="kakaologin">
							<img
								src="${path}/resources/resources2a/assets/img/account/kakao_logo01.png"width: 50%; height: 50%;>&nbsp
							Login with Kakao
						</button>
					</div>
				</div>
			...
			<div class="w-50 bg-size-cover bg-repeat-0 bg-position-center"
				style="background-image: url(${path}/resources/resources2a/assets/img/account/login02.png);"></div>
		</div>
	</main>
	<!-- Back to top button-->
	...
	<script
		src="${path}/resources/resources2a/assets/vendor/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
	<script
		src="${path}/resources/resources2a/assets/vendor/smooth-scroll/dist/smooth-scroll.polyfills.min.js"></script>
	<!-- Main theme script-->
