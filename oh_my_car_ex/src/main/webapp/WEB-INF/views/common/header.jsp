<%@page import="com.ohmycar.controller.Member" %>
...
<head>
    <title>TCAT | Try & Catch = Ticket! </title>
    <!-- Meta Tags -->
    <meta charset="utf-8">
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="${path}/resources/resources1b/images/tcat_logo_white_letter3.ico">
        ...
        <nav class="navbar navbar-expand-sm navbar-nav-sp nav-link-sp">
            <div class="container ">
                ...
                <a class="navbar-brand navbar-nav-sp nav-link-sp" href="${path}/main.do" style="margin-top:-5px">
                    <img class="navbar-brand-item light-mode-item " src="${path}/resources/resources1b/images/01_main/tcat_logo_white_letter3.png" alt="logo ">
                    <img class="navbar-brand-item dark-mode-item " src="${path}/resources/resources1b/images/01_main/tcat_logo_white_letter3.png" alt="logo ">
                </a>
                <!-- 로고 끝-->
                <!-- 메뉴 시작 -->
                ...
                <div class="nav flex-nowrap align-items-center">
                    ...
                    <c:if test="${!empty loginMember}">
                        <a class="nav-link-sp" href="${path}/member/view" >
                        	<i class="bi bi-person-square fs-4 "></i>  <!-- <i> 아이콘태그 --> 
                        </a>
                    </c:if>
                    </div>
